...
class AllPlayersState extends State<AllPlayers> {
  ...
  Future<void> loadPlayers() async {
    ...
    try {
      ...
      setState(() {
        players = fetched;
        filteredPlayers = List.from(fetched); // copy for sorting
      });
    } catch (e) {
      setState(
...
//                         ),
//                       ),
//                       // Replace the PopupMenuButton in _buildPlayerCard with this:
...
//                                   if (result == true) {
//                                     loadPlayers(); // Refresh list after edit
//                                   }
//                                 } else if (value == 'delete') {
