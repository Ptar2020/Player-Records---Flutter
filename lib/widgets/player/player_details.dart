...
import 'package:precords_android/widgets/player/update_player.dart';
...
class PlayerDetails extends StatelessWidget {
  ...
  void _openEditModal(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (_) => EditPlayerModal(player: player),
    ).then((updatedPlayer) {
      if (updatedPlayer != null && updatedPlayer is Player) {
        // Refresh the page with the updated player
        Get.off(() => PlayerDetails(player: updatedPlayer));
      }
    });
  }
...
//                     ).then((updatedPlayer) {
//                       if (updatedPlayer != null && updatedPlayer is Player) {
//                         // You probably want to refresh the UI
//                         // Since this is StatelessWidget, consider using GetX controller or callback
//                         // For now, maybe just navigate back and let parent refresh
//                         Get.back(); // close details
//                         Get.off(() => PlayerDetails(
//                             player:
//                                 updatedPlayer)); // or better: use controller
//                       }
//                     });
//                   },
//                 ),
