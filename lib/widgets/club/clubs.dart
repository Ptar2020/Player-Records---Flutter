...
//   // Reactive club count for AppBar title
//   final RxInt clubCount = 0.obs;
...
//     clubsFuture.then((list) {
//       clubCount.value = list.length;
//     }).catchError((_) {
//       clubCount.value = 0;
//     });
//   }
...
//           // Update count immediately when data is ready
...
//         future: clubsFuture,
//         builder: (context, snapshot) {
//           // snapshot tells us the current state of the async operation (clubsFuture)
...
//                           final club = clubs[index];
//                           final initial =
//                               club.shortName?.trim().isNotEmpty == true
//                                   ? club.shortName!.trim()[0].toUpperCase()
//                                   : "?";
...
//                                 try {
//                                   final fullClub =
//                                       await api.getClubDetailsById(club.id);
//                                   Get.to(
//                                       () =>
...
//                                   child: CircleAvatar(
//                                     radius: 32,
//                                     backgroundImage: club.logo?.isNotEmpty ==
//                                             true
//                                         ? CachedNetworkImageProvider(club.logo!)
//                                         : null,
//                                     child: club.logo?.isNotEmpty != true
...
//   final auth = Get.find<AuthService>();
//   late Future<List<ClubModel>> clubsFuture;
//   final clubLength = api.getAllClubs().length ;
